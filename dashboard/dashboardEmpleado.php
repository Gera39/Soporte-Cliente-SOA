...
<body>
	...
	<!-- SIDEBAR -->
        <section id="sidebar">
            ...
            <ul class="side-menu top">
                <li class="active">
                    <a href="#" onclick="loadContent('mainEmpleado.php')">
                        <i class='bx bxs-dashboard '  style='color:#0f5cd7'></i>
                        <span class="text">Inicio</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="loadContent('layouts/ticketEmpleado.php')">
	...
	<section id="content">
		...
		<nav>
			...
			<a href="#" class="nav-link">Operador <strong style="color:green;"><?=$estado?></strong> </a> 
			<form action="#">
		...
		<div id="main-content">
            ...
            <?php
                ...
                $pagina = isset($_GET['page']) ? $_GET['page'] : 'mainEmpleado.php';
                include($pagina);
            ?>
        </div>
		<!-- MAIN -->
