	...
	<!-- SIDEBAR -->
        <section id="sidebar">
            ...
            <ul class="side-menu top">
                <li class="active">
                    <a href="#" onclick="loadContent('main.php')">
                        <i class='bx bxs-dashboard '  style='color:#0f5cd7'></i>
                        <span class="text">Inicio</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="loadContent('layouts/empleados.php')">
                    <i class='bx bxs-briefcase' style='color:#0f5cd7'  ></i>
                        <span class="text">Empleados</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="loadContent('layouts/servicios.php')">
                    <i class='bx bx-server' style='color:#0f5cd7' ></i>
                        <span class="text">Servicios</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="loadContent('layouts/reportes.php')">
                    <i class='bx bxs-report' style='color:#0f5cd7' ></i>
                        <span class="text">Reportes</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="loadContent('layouts/graficas.php')">
                    <i class='bx bx-stats' style='color:#0f5cd7' ></i>
	...
	<section id="content">
		...
		<div id="main-content">
            ...
            <?php
                ...
                $pagina = isset($_GET['page']) ? $_GET['page'] : 'main.php';
                include($pagina);
            ?>
        </div>
		<!-- MAIN -->
